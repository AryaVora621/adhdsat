...
// True for 9:16 crops; lets the two-column beats stack and text scale down.
const usePortrait = () => {
...
const Hook: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ justifyContent: 'center', alignItems: 'center', padding: portrait ? '0 70px' : '0 140px' }}>
      <div style={{ opacity: s, textAlign: 'center' }}>
        <div style={{ fontFamily: font.display, fontWeight: 800, fontSize: portrait ? 80 : 104, color: fn.ink, lineHeight: 1.08 }}>
          SAT prep that works
          <br />
...
// Beat 2: sprints (landscape: text left, card right; portrait: stacked).
const Sprints: React.FC = () => {
  ...
  return (
    ...
    >
      <div style={{ flex: portrait ? undefined : 1 }}>
        <BeatHeading
      ...
      <div style={{ flex: portrait ? undefined : 1, display: 'flex', justifyContent: 'center' }}>
        <SprintCard revealFrame={50} width={portrait ? 880 : 680} />
      </div>
    </AbsoluteFill>
  );
};
...
const Momentum: React.FC = () => {
  const portrait = usePortrait();
  return (
    <AbsoluteFill style={{ justifyContent: 'center', alignItems: 'center', gap: portrait ? 44 : 60 }}>
      <div style={{ fontFamily: font.display, fontWeight: 800, fontSize: 84, color: fn.ink, textAlign: 'center' }}>
        Watch it add up.
      </div>
      <div style={{ display: 'flex', flexDirection: portrait ? 'column' : 'row', gap: portrait ? 28 : 44 }}>
